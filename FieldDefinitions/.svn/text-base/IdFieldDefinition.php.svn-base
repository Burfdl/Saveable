<?php
	...
	class IdFieldDefinition extends NumberFieldDefinition
	{
		...
		/**
		 * Manufactures a new IdFieldDefinition for method chaining
		 *
		 * @return IdFieldDefinition 
		 */
		public static function manufacture($name = null)
		{
			return new IdFieldDefinition($name);
		}
		...
		public function setIsNullable($isNullable = false) {
			return parent::setIsNullable($isNullable);
		}
		...
		{
			$number = new IdFieldDefinition($name);
			$matches = array();
