<?php
	...
	class SetFieldDefinition extends FieldDefinition
	{
		...
		{	
			$this->type = count($this->allowedValues) ? "set('".implode("', '", $this->allowedValues)."')" : "set()";
		}
		...
		public function isValidValue($value)
		{
			...
			{
				if (!in_array($bit, $this->allowedValues))
				{
					return false;
				}
			}
